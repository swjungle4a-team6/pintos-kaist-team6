...
process_create_initd (const char *file_name) {
   ...
   f_name = strtok_r(file_name, " ", &next_ptr);
...
//    printf("\n##### debuging ##### start process_exec \n f_name : %s \n\n", f_name);
   ...
   _if.cs = SEL_UCSEG;                  // code region
   _if.ds = _if.es = _if.ss = SEL_UDSEG;   // data region
   ...
   argument_stack(parse, cnt, &_if.rsp);
	// printf("\n##### debuging ##### complete argument_stack if_->rsp : %p \n\n", if_->rsp); 
...
load (const char *file_name, struct intr_frame *if_) {
	// printf("\n##### debuging ##### start load filename : %s\n\n", file_name);
